...
class User:
    ...
    - password: private string (hashed with MD5)
    """
    ...
    def password(self, pwd):
        ...
        - Hash `pwd` using MD5 before assigning to `__password`
        """
    ...
    def is_valid_password(self, pwd):
        ...
        - Returns `False` if `pwd` is `None`, not a string, or if\
                `__password` is `None`
...
if __name__ == '__main__':
    ...
    if user_1.id is None:
        print("A new User should have an id")
    ...
    if user_2.is_valid_password("No pwd"):
        print("is_valid_password should return False if no password is\
        set before")
